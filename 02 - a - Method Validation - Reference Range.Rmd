...
**Exercise:**
Transform the x-axis to log-scale using `scale_x_log10` and visually inspect for normality
...
**Exercise:**
Let's evaluate our empirically considered parametric reference ranges
