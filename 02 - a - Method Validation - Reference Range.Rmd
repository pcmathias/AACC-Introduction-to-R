...
## QC data import
Once you have loaded some data into an R object (in this case, `data`), you should always briefly visually and manually inspect it. Things to check for include:
...
*First approach using intermediate/temporary objects:*
```{r}
